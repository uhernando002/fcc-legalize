| field | value |
|---|---|
| title | 47 CFR § 25.211 - Analog video transmissions in the FSS |
| identifier | 47CFR-25-211 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-25.211 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-25.211 |
...
- Section: § 25.211
- Heading: Analog video transmissions in the FSS
...
- (a) [Reserved] (b) All conventional C-band analog video transmissions must contain an energy dispersal signal at all times with a minimum peak-to-peak bandwidth set at whatever value is necessary to meet the power flux density limits specified in § 25.208(a) and successfully coordinated internationally and accepted by adjacent U.S.
...
- (c) All initial analog video transmissions shall be preceded by a video test transmission at an uplink e.i.r.p.
- The earth station operator shall not increase power until receiving notification from the satellite network control center that the frequency and polarization alignment are satisfactory pursuant to the procedures specified in § 25.272.
- The stationary earth station operator that has successfully transmitted an initial video test signal to a satellite pursuant to this paragraph is not required to make subsequent video test transmissions if subsequent transmissions are conducted using exactly the same parameters as the initial transmission.
