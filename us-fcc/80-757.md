| field | value |
|---|---|
| title | 47 CFR § 80.757 - Topographical data |
| identifier | 47CFR-80-757 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-80.757 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-80.757 |
...
- (a) In the preparation of profile graphs and in determining the location and height above sea level of the antenna site, the elevations or contour intervals must be taken from U.S.
- If such maps are not published for the area in question, the next best topographic information must be used.
- The maps used must include the principal area to be served.
