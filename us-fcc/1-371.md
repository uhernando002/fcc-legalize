| field | value |
|---|---|
| title | 47 CFR § 1.371 - General pleading requirements |
| identifier | 47CFR-1-371 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-1.371 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-1.371 |
...
- (c) Pleadings shall consist of numbered paragraphs and must be supported by relevant evidence.
