| field | value |
|---|---|
| title | 47 CFR § 22.565 - Transmitting power limits |
| identifier | 47CFR-22-565 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-22.565 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-22.565 |
...
- The effective radiated power (ERP) of base and fixed transmitters must not exceed the applicable limits in this paragraph under any circumstances.
- Except as provided in paragraph (d) of this section, the ERP of base transmitters must not exceed 500 Watts.
- Except as provided in paragraph (d) of this section, the ERP of base transmitters must not exceed the amount that would result in an average distance to the service contour of 41.6 kilometers (26 miles) for VHF channels or 30.7 kilometers (19 miles) for UHF channels.
- The ERP of base and fixed transmitters must not exceed 500 Watts if they transmit on channel 454.025 MHz and are located less than 7 kilometers (4.3 miles) from any Private Radio Services station receiving on adjacent channel 454.0000 MHz.
- The transmitter output power of mobile transmitters must not exceed 60 watts.
