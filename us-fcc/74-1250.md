| field | value |
|---|---|
| title | 47 CFR § 74.1250 - Transmitters and associated equipment |
| identifier | 47CFR-74-1250 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-74.1250 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-74.1250 |
...
- Section: § 74.1250
- Heading: Transmitters and associated equipment
...
- (a) FM translator and booster transmitting apparatus, and exciters employed to provide a locally generated and modulated input signal to translator and booster equipment, used by stations authorized under the provisions of this subpart must be certified upon the request of any manufacturer of transmitters in accordance with this section and subpart J of part 2 of this chapter.
- (c) The following requirements must be met before translator, booster or exciter equipment will be certified in accordance with this section: (1) Radio frequency harmonics and spurious emissions must conform with the specifications of § 74.1236 of this part.
...
- (3) The apparatus shall contain automatic circuits to maintain the power output in conformance with § 74.1235(e) of this part.
- If provision is included for adjusting the power output, then the normal operating constants shall be specified for operation at both the rated power output and the minimum power output at which the apparatus is designed to operate.
- The apparatus shall be equipped with suitable meters or meter jacks so that the operating constants can be measured while the apparatus is in operation.
