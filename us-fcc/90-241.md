| field | value |
|---|---|
| title | 47 CFR § 90.241 - Radio call box operations |
| identifier | 47CFR-90-241 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-90.241 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-90.241 |
...
- Section: § 90.241
- Heading: Radio call box operations
...
- (7) Except for test purposes, each transmission must be limited to a maximum of two seconds and shall not be automatically repeated more than two times at spaced intervals within the following 30 seconds.
- Thereafter, the authorized cycle may not be reactivated for one minute.
- (8) All transmitters installed after December 10, 1970, shall be furnished with an automatic means to deactivate the transmitter in the event the carrier remains on for a period in excess of three minutes.
