| field | value |
|---|---|
| title | 47 CFR § 73.508 - Standards of good engineering practice |
| identifier | 47CFR-73-508 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-73.508 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-73.508 |
...
- Section: § 73.508
- Heading: Standards of good engineering practice
...
- (a) All noncommercial educational stations and LPFM stations operating with more than 10 watts transmitter power output shall be subject to all of the provisions of the FM Technical Standards contained in subpart B of this part.
...
- These stations must be operated, tuned, and adjusted so that emissions are not radiated outside the authorized band causing or which are capable of causing interference to the communications of other stations.
- The audio distortion, audio frequency range, carrier hum, noise level, and other essential phases of the operation which control the external effects, must be at all times capable of providing satisfactory broadcast service.
