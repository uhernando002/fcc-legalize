| field | value |
|---|---|
| title | 47 CFR § 80.1183 - Remote control for maneuvering or navigation |
| identifier | 47CFR-80-1183 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-80.1183 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-80.1183 |
...
- Section: § 80.1183
- Heading: Remote control for maneuvering or navigation
...
- (2) The message signal is composed of the following groups: (i) The documentation number group must be transmitted once and be the ship's U.S.
...
- (c) The receiving system must: (1) Reject any actuation instruction until it recognizes and accepts the company control group.
- (d) The emission employed must be G2D.
