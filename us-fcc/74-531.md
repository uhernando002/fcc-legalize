| field | value |
|---|---|
| title | 47 CFR § 74.531 - Permissible service |
| identifier | 47CFR-74-531 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-74.531 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-74.531 |
...
- This use shall not interfere with or otherwise preclude use of these broadcast auxiliary facilities by broadcast auxiliary stations transmitting aural programming between broadcast stations as provided in paragraph (b) of this section.
- This use shall not interfere with or otherwise preclude use of these broadcast auxiliary facilities by broadcast auxiliary stations transmitting aural programming between the studio and transmitter location of a broadcast station or between broadcast stations as provided in paragraphs (a) and (b) of this section.
- An aural broadcast STL or intercity relay station may not be operated solely for the transmission of operational, teleprinter or subsidiary communications.
- (g) All program material, including subsidiary communications, transmitted over an aural broadcast STL or intercity relay station shall be intended for use by broadcast stations owned or under common control of the licensee or licensees of the STL or intercity relay station.
- (h) In any case where multiplexing, is employed on an aural broadcast STL station for the simultaneous transmission of more than one aural channel, the STL transmitter must be capable of transmitting the multiple channels within the channel on which the STL station is authorized to operate and with adequate technical quality so that each broadcast station utilizing the circuit can meet the technical performance standards stipulated in the rules governing that class of broadcasting station.
- If multiplex operation is employed during the regular operation of the STL station, the additional circuits shall be in operation at the time that the required periodic performance measurements are made of the overall broadcasting system from the studio microphone input circuit to the broadcast transmitter output circuit.
