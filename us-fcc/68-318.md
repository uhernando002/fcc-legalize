| field | value |
|---|---|
| title | 47 CFR § 68.318 - Additional limitations |
| identifier | 47CFR-68-318 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-68.318 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-68.318 |
...
- Section: § 68.318
- Heading: Additional limitations
...
- Registered terminal equipment for connection to those services discussed below must incorporate the specified features.
- Automatic dialing equipment which employ means for detecting both busy and reorder signals shall be permitted an additional 13 attempts if a busy or reorder signal is encountered on each attempt.
- The dialer shall be unable to re-attempt a call to the same number for at least 60 minutes following either the second or fifteenth successive attempt, whichever applies, unless the dialer is reactivated by either manual or external means.
...
- (4) If the called party answers, and the calling equipment does not detect a compatible terminal equipment at the called end, then the automatic dialing equipment shall be limited to one additional call which is answered.
- The automatic dialing equipment shall comply with paragraphs (b)(1), (b)(2), and (b)(3) of this section for additional call attempts that are not answered.
