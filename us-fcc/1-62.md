| field | value |
|---|---|
| title | 47 CFR § 1.62 - Operation pending action on renewal application |
| identifier | 47CFR-1-62 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-1.62 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-1.62 |
...
- Section: § 1.62
- Heading: Operation pending action on renewal application
