| field | value |
|---|---|
| title | 47 CFR § 73.758 - System specifications for digitally modulated emissions in the HF broadcasting service |
| identifier | 47CFR-73-758 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-73.758 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-73.758 |
...
- Section: § 73.758
- Heading: System specifications for digitally modulated emissions in the HF broadcasting service
...
- (a) For digitally modulated emissions, the Digital Radio Mondiale (DRM) standard shall be employed.
- The initial spacing for digitally modulated emissions shall be 10 kHz.
- In all cases of this type, the 5 kHz interleaved raster used in HFBC shall be adhered to in placing the emission within these bands.
- The frequency tolerance shall be 10 Hz.
- Quadrature amplitude modulation (QAM) with orthogonal frequency division multiplexing (OFDM) shall be used.
- The protection ratio values for analogue and digital emissions for co-channel and adjacent channel conditions shall be in accordance with Resolution 543 (WRC-03) as provisional RF protection ratio values subject to revision or confirmation by a future competent conference.
