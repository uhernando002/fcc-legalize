| field | value |
|---|---|
| title | 47 CFR § 1.1705 - Forms; electronic and manual filing |
| identifier | 47CFR-1-1705 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-1.1705 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-1.1705 |
...
- Section: § 1.1705
- Heading: Forms; electronic and manual filing
...
- Operators in the Multichannel Video and Cable Television Services (MVCTS) and applicants and licensees the Cable Television Relay Service (CARS) shall use the following forms and associated schedules: (1) FCC Form 320, Basic Signal Leakage Performance Report.
- Six months after the Commission announces their availability for electronic filing, all applications and other filings using FCC Forms 320, 321, 322, 324, and 327 and their respective associated schedules must be filed electronically in accordance with the electronic filing instructions provided by COALS.
- (2) Attachments to applications must be uploaded along with the electronically filed application whenever possible.
- (3) Any associated documents submitted with an application must be uploaded as attachments to the application whenever possible.
- (2) Manual filings must be submitted to the Commission at the appropriate address with the appropriate filing fee.
...
- Parties filing applications that require frequency coordination shall, prior to filing, complete all applicable frequency coordination requirements in § 78.36 of this chapter.
