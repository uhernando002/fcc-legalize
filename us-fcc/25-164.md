| field | value |
|---|---|
| title | 47 CFR § 25.164 - Milestones |
| identifier | 47CFR-25-164 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-25.164 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-25.164 |
...
- (c)-(e) [Reserved] (f) A licensee subject to the requirements in paragraph (a) or (b) of this section must either demonstrate compliance with the applicable requirement or notify the Commission in writing that the requirement was not met, within 15 days after the specified deadline.
