| field | value |
|---|---|
| title | 47 CFR § 95.2573 - MedRadio authorized bandwidths |
| identifier | 47CFR-95-2573 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-95.2573 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-95.2573 |
...
- Section: § 95.2573
- Heading: MedRadio authorized bandwidths
...
- Such transmitters must not use more than 300 kHz of bandwidth (total) during a MedRadio communications session.
- Such transmitters must not use more than 100 kHz of bandwidth (total) during a MedRadio communications session.
- Such transmitters must not use more than 150 kHz of bandwidth (total) during a MedRadio communications session.
