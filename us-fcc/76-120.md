| field | value |
|---|---|
| title | 47 CFR § 76.120 - Network non-duplication protection and syndicated exclusivity rules for satellite carriers: Definitions |
| identifier | 47CFR-76-120 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-76.120 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-76.120 |
...
- Section: § 76.120
- Heading: Network non-duplication protection and syndicated exclusivity rules for satellite carriers: Definitions
...
- The term “zone of protection” means— (1) With respect to network non-duplication, the zone of protection within which the television station is entitled to enforce network non-duplication protection shall be that geographic area agreed upon between the network and the television station.
...
- (2) With respect to each syndicated program, the zone of protection within which the television station is entitled to enforce syndicated exclusivity rights shall be that geographic area agreed upon between the non-network program supplier, producer or distributor and the television station.
