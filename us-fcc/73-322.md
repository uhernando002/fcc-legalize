| field | value |
|---|---|
| title | 47 CFR § 73.322 - FM stereophonic sound transmission standards |
| identifier | 47CFR-73-322 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-73.322 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-73.322 |
...
- Section: § 73.322
- Heading: FM stereophonic sound transmission standards
...
- (a) An FM broadcast station shall not use 19 kHz ±20 Hz, except as the stereophonic pilot frequency in a transmission system meeting the following parameters: (1) The modulating signal for the main channel consists of the sum of the right and left signals.
- (2) The pilot subcarrier at 19 kHz ±2 Hz, must frequency modulate the main carrier between the limits of 8 and 10 percent.
- (3) One stereophonic subcarrier must be the second harmonic of the pilot subcarrier (i.e., 38 kHz) and must cross the time axis with a positive slope simultaneously with each crossing of the time axis by the pilot subcarrier.
