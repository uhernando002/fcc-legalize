| field | value |
|---|---|
| title | 47 CFR § 5.203 - Experimental authorizations for licensed broadcast stations |
| identifier | 47CFR-5-203 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-5.203 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-5.203 |
...
- Section: § 5.203
- Heading: Experimental authorizations for licensed broadcast stations
...
- (c) Experimental operations for licensed broadcast stations are subject to the following conditions: (1) The authorized power of the station may not be exceeded more than 5 percent above the maximum power specified, except as specifically authorized for the experimental operations.
...
- (3) The experimental operations may be conducted at any time the licensed station is authorized to operate, but the minimum required schedule of programming for the class and type of station must be met.
