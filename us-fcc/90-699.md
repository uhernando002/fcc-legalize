| field | value |
|---|---|
| title | 47 CFR § 90.699 - Transition of the upper 200 channels in the 800 MHz band to EA licensing |
| identifier | 47CFR-90-699 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-90.699 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-90.699 |
...
- Section: § 90.699
- Heading: Transition of the upper 200 channels in the 800 MHz band to EA licensing
...
- The replacement system provided to an incumbent during an involuntary relocation must be at least equivalent to the existing 800 MHz system with respect to the following four factors: (1) System.
- To meet the comparable facilities requirement, an EA licensee must relocate the incumbent to facilities that provide equivalent channel capacity.
- For example, if an incumbent's system consists of five 50 kHz (two 25 kHz paired frequencies) channels, the replacement system must also have five 50 kHz channels.
- If a different channel configuration is used, it must have the same overall capacity as the original configuration.
- In addition, the geographic coverage of the channels must be coextensive with that of the original system.
- Comparable facilities must provide the same quality of service as the facilities being replaced.
- In addition, where voice service is provided, the voice quality on the new system must be equal to the current system.
- If the EA licensee provides facilities that entail higher operating cost than the incumbent's previous system, and the cost increase is a direct result of the relocation, the EA licensee must compensate the incumbent for the difference.
