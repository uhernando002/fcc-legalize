| field | value |
|---|---|
| title | 47 CFR § 95.1957 - Emission standards |
| identifier | 47CFR-95-1957 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-95.1957 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-95.1957 |
...
- (b) All spurious and out-of-band emissions shall be attenuated: (1) Zero dB on any frequency within the authorized frequency segment.
- (d) The reference bandwidth of the instrumentation used to measure the emission power shall be 100 Hz for measuring emissions up to and including 250 kHz from the edge of the authorized frequency segment, and 10 kHz for measuring emissions more than 250 kHz from the edge of the authorized frequency segment.
- If a video filter is used, its bandwidth shall not be less than the reference bandwidth.
- The power level of the highest emission within the frequency segment, to which the attenuation is referenced, shall be remeasured for each change in reference bandwidth.
