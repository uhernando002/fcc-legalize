| field | value |
|---|---|
| title | 47 CFR § 30.404 - Emission limits |
| identifier | 47CFR-30-404 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-30.404 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-30.404 |
...
- (Attenuation greater than 56 decibels or to an absolute power of less than −13 dBm/1MHz is not required.) (ii) In any 1 MHz band, the center frequency of which is removed from the assigned frequency by more than 250 percent of the authorized bandwidth: At least 43 + 10 Log10 (the mean output power in watts) decibels, or 80 decibels, whichever is the lesser attenuation.
- Equipment licensed prior to April 1, 2005 shall only be required to meet this standard in any 4 kHz band.
- The emission mask shall use a value B (bandwidth) of 40 MHz, for all cases even in the case where a narrower subchannel is used (for instance the actual bandwidth is 10 MHz) and the mean output power used in the calculation is the sum of the output power of a fully populated channel.
