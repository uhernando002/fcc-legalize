| field | value |
|---|---|
| title | 47 CFR § 15.204 - External radio frequency power amplifiers and antenna modifications |
| identifier | 47CFR-15-204 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-15.204 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-15.204 |
...
- Section: § 15.204
- Heading: External radio frequency power amplifiers and antenna modifications
...
- Except as described otherwise in this section, when a transmission system is authorized as a system, it must always be marketed as a complete system and must always be used in the configuration in which it was authorized.
...
- (2) Compliance testing shall be performed using the highest gain antenna for each type of antenna to be certified with the intentional radiator.
- During this testing, the intentional radiator shall be operated at its maximum available output power level.
