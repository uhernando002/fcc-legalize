| field | value |
|---|---|
| title | 47 CFR § 73.44 - AM transmission system emission limitations |
| identifier | 47CFR-73-44 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-73.44 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-73.44 |
...
- Section: § 73.44
- Heading: AM transmission system emission limitations
...
- (a) The emissions of stations in the AM service shall be attenuated in accordance with the requirements specified in paragraph (b) of this section.
- Emissions shall be measured using a properly operated and suitable swept-frequency RF spectrum analyzer using a peak hold duration of 10 minutes, no video filtering, and a 300 Hz resolution bandwidth, except that a wider resolution bandwidth may be employed above 11.5 kHz to detect transient emissions.
- (b) Emissions 10.2 kHz to 20 kHz removed from the carrier must be attenuated at least 25 dB below the unmodulated carrier level, emissions 20 kHz to 30 kHz removed from the carrier must be attenuated at least 35 dB below the unmodulated carrier level, emissions 30 kHz to 60 kHz removed from the carrier must be attenuated at least [5 + 1 dB/kHz] below the unmodulated carrier level, and emissions between 60 kHz and 75 kHz of the carrier frequency must be attenuated at least 65 dB below the unmodulated carrier level.
...
- When a directional antenna is used, the carrier frequency reference field strength to be used in order of preference shall be: (1) The measure non-directional field strength.
- Such stations are waived from having to make the periodic measurements required in § 73.1590(a)(6) until June 30, 1994.
- However, licensees must make measurements to determine compliance with paragraphs (a) and (b) of this section upon receipt of an Official Notice of Violation or a Notice of Apparent Liability alleging noncompliance with those provisions, or upon specific request by the Commission.
