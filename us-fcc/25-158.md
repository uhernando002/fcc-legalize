| field | value |
|---|---|
| title | 47 CFR § 25.158 - Consideration of applications for GSO-like satellite operation |
| identifier | 47CFR-25-158 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-25.158 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-25.158 |
...
- Section: § 25.158
- Heading: Consideration of applications for GSO-like satellite operation
...
- (6) Licensees whose licenses are granted pursuant to paragraph (d)(4) of this section shall request contiguous bandwidth in both the uplink and downlink band.
- Each licensee's bandwidth selection shall not preclude other licensees from selecting contiguous bandwidth.
