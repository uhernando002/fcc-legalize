| field | value |
|---|---|
| title | 47 CFR § 73.61 - AM directional antenna field strength measurements |
| identifier | 47CFR-73-61 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-73.61 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-73.61 |
...
- Section: § 73.61
- Heading: AM directional antenna field strength measurements
...
- (a) Each AM station using a directional antenna with monitoring point locations specified in the instrument of authorization must make field strength measurements as often as necessary to ensure that the field at each of those points does not exceed the value specified in the station authorization.
- Additionally, stations not having an approved sampling system must make the measurements once each calendar quarter at intervals not exceeding 120 days.
