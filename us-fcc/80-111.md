| field | value |
|---|---|
| title | 47 CFR § 80.111 - Radiotelephone operating procedures for coast stations |
| identifier | 47CFR-80-111 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-80.111 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-80.111 |
...
- Section: § 80.111
- Heading: Radiotelephone operating procedures for coast stations
...
- (4) Calling a particular station must not continue for more than one minute in each instance.
- If the called station does not reply, that station must not again be called for two minutes.
- When a called station does not reply to a call sent three times at intervals of two minutes, the calling must cease for fifteen minutes.
