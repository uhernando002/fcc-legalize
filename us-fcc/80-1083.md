| field | value |
|---|---|
| title | 47 CFR § 80.1083 - Ship radio installations |
| identifier | 47CFR-80-1083 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-80.1083 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-80.1083 |
...
- Section: § 80.1083
- Heading: Ship radio installations
...
- (b) The radio installation must: (1) Be so located that no harmful interference of mechanical, electrical or other origin affects its proper use, and so as to ensure electromagnetic compatibility and avoidance of harmful interaction with other equipment and systems; (2) Be so located as to ensure the greatest possible degree of safety and operational availability; (3) Be protected against harmful effects of water, extremes of temperature and other adverse environmental conditions; (4) Be provided with reliable, permanently arranged electrical lighting, independent of the main and emergency sources of electrical power, for the adequate illumination of the radio controls for operating the radio installation; and (5) Be clearly marked with the call sign, the ship station identity and other codes as applicable for the use of the radio installation.
- (c) Control of the VHF radiotelephone channels required for navigational safety must be immediately available on the navigating bridge convenient to the conning position and, where necessary, facilities should be available to permit radiocommunications from the wings of the navigating bridge.
- Such installation must be certified in accordance with § 80.1103 and meet the requirements of IMO Resolution A.811(19) (incorporated by reference, see § 80.7).
- (e) In passenger ships, a distress panel shall be installed at the conning position.
- This panel shall contain either one single button which, when pressed, initiates a distress alert using all radiocommunications installations required on board for that purpose or one button for each individual installation.
