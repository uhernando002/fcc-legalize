| field | value |
|---|---|
| title | 47 CFR § 64.2005 - Use of customer proprietary network information without customer approval |
| identifier | 47CFR-64-2005 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-64.2005 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-64.2005 |
...
- (2) A telecommunications carrier may not use, disclose or permit access to CPNI to identify or track customers that call competing service providers.
- For example, a local exchange carrier may not use local service CPNI to track all customers that call local service competitors.
