| field | value |
|---|---|
| title | 47 CFR § 22.507 - Number of transmitters per station |
| identifier | 47CFR-22-507 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-22.507 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-22.507 |
...
- Section: § 22.507
- Heading: Number of transmitters per station
...
- Each station must have at least one transmitter.
- Licensees must file timely renewal applications for site-specific authorizations included in a single system-wide authorization request until the request is approved.
