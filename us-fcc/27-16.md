| field | value |
|---|---|
| title | 47 CFR § 27.16 - Network access requirements for Block C in the 746-757 and 776-787 MHz bands |
| identifier | 47CFR-27-16 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-27.16 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-27.16 |
...
- Section: § 27.16
- Heading: Network access requirements for Block C in the 746-757 and 776-787 MHz bands
...
- This section shall apply only to the authorizations for Block C in the 746-757 and 776-787 MHz bands assigned and only if the results of the first auction in which licenses for such authorizations are offered satisfied the applicable reserve price.
...
- For purposes of paragraph (b)(1) of this section: (1) Standards shall include technical requirements reasonably necessary for third parties to access a licensee's network via devices or applications without causing objectionable interference to other spectrum users or jeopardizing network security.
