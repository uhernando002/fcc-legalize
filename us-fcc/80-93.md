| field | value |
|---|---|
| title | 47 CFR § 80.93 - Hours of service |
| identifier | 47CFR-80-93 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-80.93 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-80.93 |
...
- (2) For GMDSS ships, radios shall be turned on and set to proper watch channels while ships are underway.
- If a ship has duplicate GMDSS installations for DSC or INMARSAT, only one of each must be turned on and keeping watch.
- For ships voluntarily fitting GMDSS subsystems, radios shall be turned on and set to proper watch channels while ships are underway.
- If ship has duplicate GMDSS installations for DSC or INMARSAT, only one of each must be turned on and keeping watch.
