| field | value |
|---|---|
| title | 47 CFR § 24.238 - Emission limitations for Broadband PCS equipment |
| identifier | 47CFR-24-238 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-24.238 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-24.238 |
...
- Section: § 24.238
- Heading: Emission limitations for Broadband PCS equipment
...
- A narrower resolution bandwidth is permitted in all cases to improve measurement accuracy provided the measured power is integrated over the full required measurement bandwidth (i.e.
