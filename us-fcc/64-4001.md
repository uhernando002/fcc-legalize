| field | value |
|---|---|
| title | 47 CFR § 64.4001 - Definitions |
| identifier | 47CFR-64-4001 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-64.4001 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-64.4001 |
...
- Terms in this subpart have the following meanings: (a) Automatic number identification (ANI).
- The term automatic number identification refers to the delivery of the calling party's billing telephone number by a local exchange carrier to any interconnecting carrier for billing or routing purposes.
- (b) Billing name and address (BNA).
- The term billing name and address means the name and address provided to a [LEC] by each of its local exchange customers to which the [LEC] directs bills for its services.
- The term customer means the end user to whom a local exchange carrier or interexchange carrier is providing local exchange or telephone toll service.
