| field | value |
|---|---|
| title | 47 CFR § 51.505 - Forward-looking economic cost |
| identifier | 47CFR-51-505 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-51.505 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-51.505 |
...
- Section: § 51.505
- Heading: Forward-looking economic cost
...
- The forward-looking cost of capital shall be used in calculating the total element long-run incremental cost of an element.
...
- (i) The sum of a reasonable allocation of forward-looking common costs and the total element long-run incremental cost of an element shall not exceed the stand-alone costs associated with the element.
...
- The following factors shall not be considered in a calculation of the forward-looking economic cost of an element: (1) Embedded costs.
...
- (2) Any state proceeding conducted pursuant to this section shall provide notice and an opportunity for comment to affected parties and shall result in the creation of a written factual record that is sufficient for purposes of review.
