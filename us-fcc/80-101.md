| field | value |
|---|---|
| title | 47 CFR § 80.101 - Radiotelephone testing procedures |
| identifier | 47CFR-80-101 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-80.101 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-80.101 |
...
- Section: § 80.101
- Heading: Radiotelephone testing procedures
...
- (a) Station licensees must not cause harmful interference.
- When radiation is necessary or unavoidable, the testing procedure described below must be followed: (1) The operator must not interfere with transmissions in progress.
...
- (3) If any station responds “wait”, the test must be suspended for a minimum of 30 seconds, then repeat the call sign followed by the word “test” and listen again for a response.
- To continue the test, the operator must use counts or phrases which do not conflict with normal operating signals, and must end with the station's call sign.
- Test signals must not exceed ten seconds, and must not be repeated until at least one minute has elapsed.
- On the frequency 2182 kHz or 156.800 MHz, the time between tests must be a minimum of five minutes.
