| field | value |
|---|---|
| title | 47 CFR § 80.1101 - Performance standards |
| identifier | 47CFR-80-1101 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-80.1101 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-80.1101 |
...
- (5) International Telecommunication Union—Radiocommunication Bureau (ITU-R) (Standards formerly designated as CCIR are now designated as ITU-R.) (b) All equipment specified in this subpart must meet the general requirements for shipboard equipment in conformity with performance specifications listed in this paragraph, which are incorporated by reference.
- (c) The equipment specified in this subpart must also conform to the appropriate performance standards listed in paragraphs (c)(1) through (12) of this section, which are incorporated by reference (see § 80.7), and must be tested in accordance with the applicable IEC testing standards listed in paragraph (c)(13) of this section, which are also incorporated by reference.
