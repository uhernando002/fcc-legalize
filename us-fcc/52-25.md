| field | value |
|---|---|
| title | 47 CFR § 52.25 - Database architecture and administration |
| identifier | 47CFR-52-25 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-52.25 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-52.25 |
...
- Section: § 52.25
- Heading: Database architecture and administration
...
- (f) The information contained in the regional databases shall be limited to the information necessary to route telephone calls to the appropriate telecommunications carriers.
- The NANC shall determine what specific information is necessary.
- A state must notify the Wireline Competition Bureau and NANC that it plans to implement a state-specific database within 60 days from the release date of the Public Notice issued by the Chief, Wireline Competition Bureau, identifying the administrator selected by the NANC and the proposed locations of the regional databases.
