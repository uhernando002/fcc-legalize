| field | value |
|---|---|
| title | 47 CFR § 80.325 - Control of distress traffic |
| identifier | 47CFR-80-325 |
| country | us |
| rank | regulation |
| publication_date | 2026-04-17 |
| last_updated | 2026-04-16 |
| status | in_force |
| source | https://www.ecfr.gov/current/title-47/section-80.325 |
| department | Federal Communications Commission |
| eli | https://www.ecfr.gov/current/title-47/section-80.325 |
...
- (a) Distress traffic consists of all messages relating to the immediate assistance required by the mobile station in distress.
- In distress traffic, the distress signal must be sent before the call and at the beginning of the preamble of any radiotelegram.
- It must address these instructions “to all stations” or to one station only, according to circumstances.
- In either case, it must use one of the following signals which are reserved for use by the mobile station in distress and for the station controlling distress traffic: (1) In radiotelegraphy, the abbreviation QRT, followed by the distress signal SOS.
- It must use for this purpose: (1) In radiotelegraphy, the abbreviation QRT, followed by the word DISTRESS and its own call sign; (2) In radiotelephony, the word SEELONCE, followed by the word DISTRESS and its own call sign or other identification.
